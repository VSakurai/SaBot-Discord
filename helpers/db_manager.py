...
async def get_blacklisted_users() -> list:
    """
    Эта функция вернет список всех пользователей из черного списка.
    :param user_id: Идентификатор пользователя, которого необходимо проверить.
    :return: True, если пользователь занесен в черный список, False, если нет.
    """
...
async def is_blacklisted(user_id: int) -> bool:
    """
    Эта функция проверит, находится ли пользователь в черном списке.
    :param user_id: Идентификатор пользователя, которого необходимо проверить.
    :return: True, если пользователь занесен в черный список, False, если нет.
    """
    async with aiosqlite.connect(DATABASE_PATH) as db:
